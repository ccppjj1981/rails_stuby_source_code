...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallerie.count') do
      post galleries_url, params: { gallery: { images: @gallery.images, name: @gallery.name } }
    end

    assert_redirected_to gallery_url(Gallerie.last)
  end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { images: @gallery.images, name: @gallery.name } }
